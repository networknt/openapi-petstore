...
public class AccountsAccountNoPutHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(AccountsAccountNoPutHandlerTest.class);
    ...
    @Test
    public void testAccountsAccountNoPutHandlerTest() throws ClientException {
        final CountDownLatch latch = new CountDownLatch(1);
        SimpleConnectionState.ConnectionToken connectionToken = null;
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/v1/accounts/jJnXKgn";
