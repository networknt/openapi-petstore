...
public class AccountsAccountNoGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(AccountsAccountNoGetHandlerTest.class);
    ...
    @Test
    public void testAccountsAccountNoGetHandlerTest() throws ClientException {
        final CountDownLatch latch = new CountDownLatch(1);
        SimpleConnectionHolder.ConnectionToken connectionToken = null;
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/v1/accounts/USWvgMQNKkO";
